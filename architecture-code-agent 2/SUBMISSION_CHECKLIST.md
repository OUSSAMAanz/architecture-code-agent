...
- [ ] Run `npm start`, open `http://localhost:3000/`, and play through the UI.
...
> tests, and a generated playable Space Fractions web game with a responsive user
> interface. I have also included research on Claude Code's implementation
> mechanisms and full usage instructions.
>
...
Use `docs/DEMO_SCRIPT.md` as a recording outline and show the playable game UI,
not only the `/health` endpoint. Do not display an
